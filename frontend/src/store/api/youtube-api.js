...
export const buildMostPopularVideosRequest = (amount = 12, loadDescription = false, nextPageToken, videoCategoryId = null) => {
    let fields = 'nextPageToken, prevPageToken, items(contentDetails, channelTitle, publishedAt, thumbnails/medium, title), statistics/viewCount), pageInfo(totalResults)';
    if (loadDescription) {
